...
async def start(message: Message):
    ...
    greeting_text = (
        f"Привет, <b>{user_name}</b>! 🌟 Это бот, который поможет тебе решать"
        " задачи по экономической теории. Спасибо, что решил воспользоваться"
        " нашим сервисом! Вот задачи, которые мы можем решить:\n\n<b>1)"
        " Построение общей КПВ:</b>\n   Вводи максимальный объем производства"
        " товаров А и Б для 1 и 2 производителя, а мы построим график общей"
        " КПВ!\n\n<b>2) Нахождение точки рыночного равновесия:</b>\n   По"
        " определенным формулам и твоим данным, мы посчитаем параметры"
        " равновесия в считанные секунды.\n\n<b>3) Расчет объема"
        " дефицита/излишка:</b>\n   Получи ответ о ситуации на рынке при"
        " уровне цены в определенное количество денежных единиц.\n\n<b>4)"
        " Расчет прибыли фирмы:</b>\n   Узнай, сколько составит прибыль при"
        " реализации продукции. Мы готовы помочь!"
    )
